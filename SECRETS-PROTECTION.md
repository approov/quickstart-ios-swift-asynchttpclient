...
After this the `ApproovAsyncHTTPClient` should transform any instance of a URL such as `https://your.domain/endpoint?your-param=your-secret-name` into `https://your.domain/endpoint?your-param=your-secret-value`.
...
var secret:String?
do {
    try secret = ApproovService.fetchSecureString(key:"your-secret-name", newDef: null)
